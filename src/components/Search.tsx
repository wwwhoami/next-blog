    ...
    >
      ...
      >
        ...
        {term.length !== 0 ? (
          <button
            type="button"
            className="mr-2 inline size-5 rounded-full focus-ring-primary"
