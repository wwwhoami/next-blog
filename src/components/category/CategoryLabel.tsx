...
export default function CategoryLabel({ children, hexColor }: Props) {
  return (
    <div
      className="group inline-flex w-auto cursor-default 
      items-center justify-around rounded-lg border-2 border-gray-300 bg-transparent px-3 py-1.5 
      text-center text-sm font-normal text-gray-700 focus-ring-secondary 
